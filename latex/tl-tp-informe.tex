...
\Tree [.$E$ [.\texttt{\textbackslash} ]
            [.\texttt{var} ]
            [.\texttt{:} ]
            [.$T$ [.$T'$ [.\texttt{type} ] ] ]
            [.\texttt{.} ]
            [.$E$ [.$A$ [.$A$ [.$E'$ [.\texttt{(} ] 
                                     [.$E$ [.\texttt{\textbackslash} ] 
                                           [.\texttt{var} ]
                                           [.\texttt{:} ]
                                           [.$T$ [.$T'$ [.\texttt{type} ] ] ]
                                           [.\texttt{.} ]
...
\small
\lstinputlisting[style=numbered]{../src/lambdacalculus/lexer.py}

\subsection*{\texttt{parser.py}}
\small
\lstinputlisting[style=numbered]{../src/lambdacalculus/parser.py}

\subsection*{\texttt{expression.py}}
\small
\lstinputlisting[style=numbered]{../src/lambdacalculus/expression.py}

\subsection*{\texttt{exp\_type.py}}
\small
\lstinputlisting[style=numbered]{../src/lambdacalculus/exp_type.py}
